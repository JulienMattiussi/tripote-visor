export const translations = {
  en: {
    ...
    hero: {
      ...
      tab_things: 'Parks',
      tab_alleys: 'Alleys',
      placeholder_all: 'A name, a city, a fancy…',
      placeholder_hotels: 'A name, a city, a fancy…',
      placeholder_things: 'A name, a city, a fancy…',
      placeholder_alleys: 'A name, a city, a fancy…',
      compact_placeholder: 'A name, a city, a fancy…',
    },
    ttd: {
      aria: 'Things to do promo',
      alt_image: 'A spray from a soda bottle',
      headline_line1: 'Find',
    ...
    experiences: {
      title: 'Must-tries in incredible places',
      subtitle: 'Four cities, four exceptional experiences.',
      from_price: 'from {amount}',
    },
    tc: {
    ...
    community: {
      title: 'Tripote-visor: join the largest user community',
    ...
    listings: {
      ...
      from_per_session: 'from {amount} / appointment',
    ...
    profile_page: {
      ...
      see_all_schedule: 'View all hours',
      action_site: 'Website',
      action_menu: 'Card',
      action_phone: 'Phone',
      action_email: 'E-mail',
  ...
  fr: {
    ...
    hero: {
      ...
      tab_things: 'Parcs',
      tab_alleys: 'Ruelles',
      placeholder_all: 'Un nom, une ville, une envie…',
      placeholder_hotels: 'Un nom, une ville, une envie…',
      placeholder_things: 'Un nom, une ville, une envie…',
      placeholder_alleys: 'Un nom, une ville, une envie…',
      compact_placeholder: 'Un nom, une ville, une envie…',
    },
    ttd: {
      aria: 'Promo activités',
      alt_image: 'Un jet provenant d’une bouteille de soda',
    ...
    experiences: {
      ...
      subtitle: 'Quatre villes, quatre expériences exceptionnelles.',
      from_price: 'à partir de {amount}',
    },
    tc: {
    ...
    pp_page: {
      ...
      place_label: 'À quelle profile ces photos sont-elles destinées ?',
      place_placeholder: 'Rechercher quelqu’un',
    ...
    cl_page: {
      ...
      description_placeholder:
        'Une phrase ou deux que les utilisateurs verront en arrivant sur la profile.',
    ...
    listings: {
      ...
      from_per_session: 'à partir de {amount} / prestation',
    ...
    resources_page: {
      ...
      review_journey_intro:
        'Chaque soumission passe par un processus en plusieurs étapes avant de paraître sur une profile. Ce survol couvre :',
    ...
    safety_page: {
      ...
      sanction_b2:
        'Chaque publication frauduleuse fait reculer la profile dans le classement par popularité.',
      sanction_b3:
      ...
      sanction_b4:
        'Nous ne supprimons pas silencieusement la profile elle-même, car les clients ont le droit de lire ce que d’autres ont pensé - mais la profile assume les conséquences de son comportement.',
    ...
    login_required_modal: {
      ...
      message_save: 'Vous devez être connecté pour enregistrer la profile de {name}.',
      ...
      message_add_place:
        'Vous devez être connecté pour soumettre « {name} » comme nouvelle profile.',
    ...
    search_page: {
      ...
      section_alley: 'Ruelles',
      section_park: 'Parcs',
      card_meta: '{age} ans · {cat}',
      save_aria: 'Enregistrer',
    },
    profile_page: {
      not_found: 'Cette profile est introuvable.',
      back_home: 'Retour à l’accueil',
      ...
      see_all_schedule: 'Voir tous les horaires',
      ...
      save_title: 'Enregistrer cette profile',
      ...
      see_all_reviews: 'Voir les {count} avis',
